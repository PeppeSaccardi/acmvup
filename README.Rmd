...
The goal of acmvup is to provide some useful functions are implemented following the additive covariance modeling via unconstrained parametrization. 

## Installation

You can install the released version of acmvup from [CRAN](https://CRAN.R-project.org) with:
